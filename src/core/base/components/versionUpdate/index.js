                    ...
                    <Modal onRequestClose={() => null} visible={true} transparent={true} animationType="fade">
                        <View activeOpacity={1} style={styles.container}>
                            <View style={styles.dialog}>
                                <H3 style={{color: variable.toolbarDefaultBg, marginBottom: 15}}>Update is available</H3>
                                ...
                                >
                                    ...
                                    >
                                        <Text style={{color: variable.toolbarDefaultBg, fontWeight: '900'}}>Update now</Text>
                                    </Button>
                                </View>
                            </View>
