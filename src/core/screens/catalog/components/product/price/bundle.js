...
class Bundle extends React.Component {
    ...
    renderView(){
        ...
        let configured_label = null;
        let configured_price = null;
        ...
        if (this.prices.minimal_price && this.prices.minimal_price == 1) {
            if (this.prices.show_ex_in_price && this.prices.show_ex_in_price == 1) {
                price_label = <Language style={this.parent.style.styleLabel} text={this.prices.price_label}/>;
                price_excluding_tax = <View style={this.parent.style.styleOneRowPrice}>
                ...
                price_label = (<View style={this.parent.style.styleOneRowPrice}>
            ...
            if (this.prices.show_from_to_tax_price && this.prices.show_from_to_tax_price == 1) {
                if (this.prices.show_ex_in_price && this.prices.show_ex_in_price == 1) {
                    product_from_label =<Language style={this.parent.style.styleLabel} text={this.prices.product_from_label}/>;
                    ...
                    product_to_label = <Language style={this.parent.style.styleLabel} text={this.prices.product_to_label}/>;
        ...
        if (this.prices.configure) {
            configured_label = <Language style={this.parent.style.styleLabel} text={this.prices.configure.product_label}/>;
