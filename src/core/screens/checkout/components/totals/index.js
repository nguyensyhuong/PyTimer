        ...
        if(data){
            ...
            if (this.tax_cart_display_subtotal === 1 && data.subtotal_excl_tax) {
                ...
                subtotal = (<View style={this.props.styleTwoRowPrice}>
                    {data.subtotal_excl_tax ?
                        <View style={this.props.styleOneRowPrice}>
                            <Language text={'Subtotal (Excl. Tax)'} style={this.props.styleLabel}/>
                            <Format price={data.subtotal_excl_tax} style={this.props.stylePrice} type={this.type} currency_symbol={this.currency_symbol}/>
                        </View> : null
                    }
                    {data.subtotal_incl_tax ?
                        <View style={this.props.styleOneRowPrice}>
                            <Language text={'Subtotal (Incl. Tax)'} style={this.props.styleLabel}/>
                            <Format price={data.subtotal_incl_tax} style={this.props.stylePrice} type={this.type} currency_symbol={this.currency_symbol}/>
                        </View> : null
                    }</View>);
            }
            ...
            if (this.tax_cart_display_shipping === 1 && data.shipping_hand_excl_tax) {
                if (data.shipping_hand_excl_tax) {
                    ...
                    shipping = (
                        <View style={this.props.styleOneRowPrice}>
                            <Language text={'Shipping (Excl. Tax)'} style={this.props.styleLabel}/>
                ...
                if (data.shipping_hand_incl_tax) {
                    ...
                    shipping = (
                        <View style={this.props.styleOneRowPrice}>
                            <Language text={'Shipping (Incl. Tax)'} style={this.props.styleLabel}/>
            ...
            if (data.discount) {
                discount = (
                    <View style={this.props.styleOneRowPrice}>
                        <Language text={'Discount'} style={this.props.styleLabelDiscount}/>
            ...
            if (data.tax) {
                tax = (
                    <View style={this.props.styleOneRowPrice}>
                        <Language text={'Tax'} style={this.props.styleLabel}/>
            ...
            if (this.tax_cart_display_grandtotal === 1) {
                grand_total = (<View style={this.props.styleTwoRowPrice}>
                    {data.grand_total_excl_tax ?
                        <View style={this.props.styleOneRowPrice}>
                            <Language text={'Grand Total (Excl. Tax)'} style={this.props.styleLabelTotal}/>
                            <Format price={data.grand_total_excl_tax} style={this.props.stylePriceTotal} type={this.type} currency_symbol={this.currency_symbol}/>
                        </View> : null
                    }
                    {data.grand_total_incl_tax ?
                        <View style={this.props.styleOneRowPrice}>
                            <Language text={'Grand Total (Incl. Tax)'} style={this.props.styleLabelTotal}/>
                            <Format price={data.grand_total_incl_tax} style={this.props.stylePriceTotal} type={this.type} currency_symbol={this.currency_symbol}/>
                        </View> : null
                    }
                </View>);
...
Totals.defaultProps = {
    ...
    styleLabel : {},
    stylePrice : {},
    styleLabelTotal : {fontSize: material.textSizeLabel, color: 'red'},
    stylePriceTotal : {fontSize: material.textSizeLabel, color: 'red'},
    styleLabelDiscount : {color: 'red'},
    stylePriceDiscount : {color: 'red'},
    //one row.
