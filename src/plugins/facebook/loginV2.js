...
class AddFBLogin extends SimiComponent {
    ...
    renderPhoneLayout() {
        const that = this;
        console.log('dsf', Identify.getMerchantConfig().storeview.base)
        if(Identify.getMerchantConfig().storeview.base && Identify.getMerchantConfig().storeview.base.enable_facebook_login == '1') {
            return (
